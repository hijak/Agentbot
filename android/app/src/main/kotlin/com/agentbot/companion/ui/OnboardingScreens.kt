...
object OnboardingCopy {
    ...
    const val UNPAIRED_HOME_BODY =
        "Pair this phone with Agentbot to see your chats and respond to your bots."
    const val UNPAIRED_HOME_HINT =
        "On your computer, open Agentbot → Settings → Phone."
 ...
 * [com.agentbot.companion.core.NotificationOnboardingPolicy].
 */
@Composable
