package com.agentbot.companion.notifications

import android.content.Intent
import android.net.Uri
import com.agentbot.companion.MainActivity
...
object NotificationIntents {
    const val ACTION_OPEN = "com.agentbot.companion.OPEN_NOTIFICATION"
    ...
    fun contentIdentity(botId: String, threadId: String): String =
        "agentbot://notification/${encode(botId)}/${encode(threadId)}"
