...
import com.agentbot.companion.core.RoutineInput
...
object RoutineRules {
    ...
    const val UNKNOWN_SCHEDULE_NOTE: String =
        "This routine uses a schedule added by a newer Agentbot. Choose One time, " +
    ...
    const val CLOUD_READY_FOOTER: String =
        "Runs the agent and its tools inside its Box virtual machine. The VM wakes " +
            "automatically for each run; keep Agentbot running so its scheduler can " +
            "launch the job."
