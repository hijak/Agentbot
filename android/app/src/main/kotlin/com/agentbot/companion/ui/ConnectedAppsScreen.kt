...
import com.agentbot.companion.core.ConnectedAppsRules
import com.agentbot.companion.core.ConnectorAccount
import com.agentbot.companion.core.ConnectorCard
import com.agentbot.companion.core.ConnectorCatalog
import com.agentbot.companion.core.ConnectorStatus
import com.agentbot.companion.core.ConnectorStatuses
        ...
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(6.dp)) {
            ...
            Text(
                if (hasLastKnownInventory) {
                    "Showing what was connected last time. Your computer could not open its credential store just now, so these accounts could not be re-checked. Nothing has been disconnected — restarting Agentbot on your computer usually clears this."
                } else {
                    "Your computer could not open its credential store, so it cannot say which accounts are connected. Nothing has been disconnected — restarting Agentbot on your computer usually clears this."
                },
                color = secondaryTint,
                fontSize = 13.sp,
            )
