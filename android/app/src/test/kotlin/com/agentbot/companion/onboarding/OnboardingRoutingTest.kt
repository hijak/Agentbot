...
import com.agentbot.companion.core.NotificationAuthorizationState
import com.agentbot.companion.core.OnboardingPairingState
...
import com.agentbot.companion.ui.notificationAuthorization
import com.agentbot.companion.ui.onboardingPairingState
import com.agentbot.companion.ui.OnboardingCopy
...
class OnboardingRoutingTest {
    ...
    fun `a deep link opens pairing even on a first launch nobody has answered`() {
        ...
        scene.session.receivePairingURL(
            "agentbot://pair?address=127.0.0.1:8810&code=123456",
        )
        compose.waitForIdle()
