...
const IMAGE = process.env.AGENTBOT_DEB_SMOKE_IMAGE || "ubuntu:24.04";
const RUNTIME = process.env.AGENTBOT_DEB_SMOKE_RUNTIME || "docker";
...
const staged = "/root/pending dir/o'brien/Agentbot.deb";
...
const installed = inContainer(
  [
    ...
    'test -x /opt/Agentbot/agentbot && echo "EXECUTABLE=yes"',
  ].join("\n"),
);
