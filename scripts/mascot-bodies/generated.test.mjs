...
const KOTLIN_PATH = "../../android/app/src/main/kotlin/com/agentbot/companion/ui/MausBodies.kt";
...
describe("generated catalogs", () => {
  it("match a fresh run of the generator", () => {
    ...
    try {
      ...
      throw new Error(
        `Running \`pnpm gen:bodies\` failed while checking the catalogs for drift. ` +
          ...
          `\`git status\` / \`git diff -- shared/mascot-bodies.ts ios/Sources/CompanionCore/MausBodies.swift android/app/src/main/kotlin/com/agentbot/companion/ui/MausBodies.kt\` ` +
    ...
    const drifts = [
      ...
      describeDrift("android/app/src/main/kotlin/com/agentbot/companion/ui/MausBodies.kt", before.kotlin, after.kotlin),
    ].filter(Boolean);
