...
const resources = process.env.AGENTBOT_CUA_RESOURCES ?? join(root, "dist-native", hostArch);
...
const host = new EmbeddedCuaDriverHost(binary, "com.agentbot.app");
let proxy;
...
try {
  ...
  await rpc("initialize", {
    ...
    capabilities: {},
    clientInfo: { name: "agentbot-package-smoke", version: "1" },
  });
