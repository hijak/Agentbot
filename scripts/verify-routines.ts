...
try {
  ...
  writeFileSync(wrapper, [
    ...
    'const bot = at < 0 ? null : JSON.parse(readFileSync(process.argv[at + 1], "utf8")).mcpServers?.agents?.env?.AGENTBOT_BOT_ID;',
  ...
  ui = await mountPreview(fixture, {
    entry: "/scripts/testing/threads-preview.tsx", route: "/__routines.html", title: "Isolated Agentbot Routines",
  });
