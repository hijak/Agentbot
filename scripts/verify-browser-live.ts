...
const binaryPath = process.env.AGENTBOT_VERIFY_BROWSER_BINARY;
const executablePath = process.env.AGENTBOT_VERIFY_BROWSER_CHROME;
if (!binaryPath || !executablePath) throw new Error("Set AGENTBOT_VERIFY_BROWSER_BINARY and AGENTBOT_VERIFY_BROWSER_CHROME to explicit installed binaries.");
