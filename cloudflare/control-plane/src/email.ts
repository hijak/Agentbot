...
const SUBJECTS = {
  "sign-in": "Your Agentbot sign-in code",
  "email-verification": "Verify your Agentbot email",
  "forget-password": "Reset your Agentbot password",
  "change-email": "Confirm your Agentbot email change",
