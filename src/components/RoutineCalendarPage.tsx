...
const BOT_DRAG_TYPE = "application/x-agentbot-bot";
const EVENT_DRAG_TYPE = "application/x-agentbot-calendar-event";
            ...
            <div className="min-w-0 flex-1 space-y-3">
              ...
              {kind === "routine" && (
                <p className="text-[11px] leading-relaxed text-ink-secondary">
                  Runs while Agentbot is open on this computer — it cannot wake a sleeping Mac. A run missed by less than 12 hours still happens when the app is back; for 24/7, run Agentbot on a VPS.
                </p>
              )}
              ...
              <div className="min-w-0 flex-1">
                {isRoomGoal ? (
                  <div className="rounded-xl border border-accent/35 bg-accent/[0.07] p-3">
                    ...
                    <div className="mt-1 text-[11px] leading-relaxed text-ink-secondary">Agentbot keeps the group and its member hand-offs together for the full goal.</div>
                  </div>
