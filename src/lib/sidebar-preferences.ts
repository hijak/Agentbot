...
export const SIDEBAR_DENSITY_KEY = "agentbot.sidebarDensity";
export const SIDEBAR_ATTENTION_PINNED_KEY = "agentbot.sidebarAttentionPinned.v1";
export const SIDEBAR_COLLAPSED_SECTIONS_KEY = "agentbot.sidebarCollapsedSections.v1";
export const SIDEBAR_SECTION_ORDER_KEY = "agentbot.sidebarSectionOrder.v1";
