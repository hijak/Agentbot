...
`AGENTBOT_VERIFY_PODMAN`, `AGENTBOT_VERIFY_MACHINE`, and `AGENTBOT_VERIFY_IMAGE`, then run:
...
engine-host temporary workspaces. Use `AGENTBOT_VERIFY_OUTPUT` for a separate evidence
