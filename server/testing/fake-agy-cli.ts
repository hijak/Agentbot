...
//     reads Agentbot's temporary `agentbot-agents` entry from agy's
...
function agentsMcpEntry(): McpEntry | null {
  ...
  try {
    ...
    const entry = config.mcpServers?.["agentbot-agents"];
  ...
  return new Promise((resolve, reject) => {
    ...
    write({
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: "agentbot-fake-antigravity", version: "1.0.0" },
      },
    });
  });
}
