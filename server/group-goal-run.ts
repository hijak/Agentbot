...
export const GROUP_GOAL_CONTROL_OPEN = "<agentbot-goal>";
export const GROUP_GOAL_CONTROL_CLOSE = "</agentbot-goal>";
...
export function groupGoalWorkerInstructions(args: {
  ...
  return [
    ...
    `Address your result to ${args.coordinatorName}. Do not invent a new orchestration protocol or emit an agentbot-goal control envelope.`,
  ].join("\n");
}
