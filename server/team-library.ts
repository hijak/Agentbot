...
export const TEAM_LIBRARY_REPOSITORY = "https://github.com/milind-soni/agentbot-teams";
export const TEAM_LIBRARY_RAW_ROOT = "https://raw.githubusercontent.com/milind-soni/agentbot-teams/main";
...
export function parseTeamCatalog(value: unknown): TeamCatalog {
  if (!isRecord(value) || value.format !== "agentbot.catalog" || value.version !== 1) {
