...
/** FTS5 is in every runtime Agentbot supports — node:sqlite on Node ≥ 24
...
export function describeMissingFts5(error: unknown): Error | null {
  ...
  return new Error(
    `Agentbot needs SQLite with FTS5, which is built into Node 24 and newer (and into the app). ` +
