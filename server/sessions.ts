 ...
 * AGENTBOT_SESSION_TTL_DAYS overrides the 30-day default. */
export const SESSION_TTL_MS = daysMs(process.env.AGENTBOT_SESSION_TTL_DAYS, 30);
 ...
 * bounded life and every device re-pairs occasionally. AGENTBOT_SESSION_MAX_DAYS
 * overrides the 180-day default. */
export const SESSION_MAX_AGE_MS = daysMs(process.env.AGENTBOT_SESSION_MAX_DAYS, 180);
