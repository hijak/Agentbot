...
async function probeRemoteMcpServer(
  ...
  try {
    await client.initialize("Agentbot", combined);
 ...
 * tools. It is always reaped, never inherits Agentbot credentials, and never
  ...
  return new Promise((resolve) => {
    ...
    write({
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: "Agentbot", version: "probe" },
      },
    });
  });
}
