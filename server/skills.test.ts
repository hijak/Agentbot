...
// reads AGENTBOT_DATA_DIR at import time — so point the suite at a scratch dir
...
// AGENTBOT_DATA_DIR is set by the harness. Here we isolate by botId.
...
beforeEach(() => {
  scratch = mkdtempSync(join(tmpdir(), "agentbot-skills-"));
  process.env.AGENTBOT_TEST_UNUSED = scratch; // keep cleanup symmetrical
