...
export const BOT_PACKAGE_FORMAT = "agentbot.package" as const;
...
const packageSchema = z.object({
  format: z.literal(BOT_PACKAGE_FORMAT, { error: "This is not an Agentbot package" }),
 ...
 * run without Agentbot or another proprietary parser. */
