...
const service: ServiceInfo = {
  ...
  type: "_agentbot._tcp",
  port: 8800,
  host: "agentbot-1a2b3c4d.local",
  addresses: ["192.168.1.42"],
  txt: ["v=1", "name=Milind's computer"],
};

const INSTANCE = "Milind's computer._agentbot._tcp.local";
const SERVICE_NAME = "_agentbot._tcp.local";
