...
// ~/.agentbot would be reaching into somebody else's data layout — the
...
/** AGENTBOT_COMPANION_DIR isolates a test rig from a real paired fleet. */
export const DATA_DIR = process.env.AGENTBOT_COMPANION_DIR ?? join(homedir(), ".agentbot-companion");
