...
- **Windows exception: agent-browser 0.36.0-agentbot.1** is an Agentbot vendor
...
Set `AGENTBOT_BROWSER_ARCHIVE_DIR` to a directory of reviewed vendor assets for an
offline build; cached bytes are still verified. Browser dependencies are
updated through reviewed Agentbot releases, not a silent browser updater.

On macOS, release signing applies Agentbot's Developer ID to native
...
imply endorsement of Agentbot. This provenance record is not legal advice
