# Agentbot Contributor License Agreement

This agreement covers contributions to the `enterprise/` directory of the
Agentbot repository, which is licensed under the Agentbot Enterprise
...
1. **Copyright license.** You grant Milind Soni ("the Project Owner") and
   ...
   under any license, including the Agentbot Enterprise License and the
   Apache License 2.0.
