                ...
                if session.canAdminister {
                    Section {
                        ...
                        Text(imageGenerationReady
                             ...
                             : "To generate images, configure the shared image provider in Agentbot on your computer. Provider keys cannot be added from this device.")
                    }
                }
                ...
                Section {
                    ...
                    if !voiceConfigured {
                        ...
                        if usesSystemVoices {
                            ...
                            Text("Add the shared Fish Audio key in Agentbot on your computer. The key is never returned to iOS.")
                        } else {
