    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Alerts arrive while Agentbot is open or was recently in the background. Closed-app delivery is not available yet.")
            }
            ...
            Section {
                ...
                Text("Changes the language inside AgentbotMobile. Buttons drawn by iOS itself follow the phone's language, which you can set for this app in iOS Settings.")
            }
            ...
            if !otherComputers.isEmpty {
                Section("Other computers") {
                    ForEach(otherComputers) { computer in
                        ...
                        .accessibilityHint("Switches AgentbotMobile to this computer")
                    }
                }
            }
...
struct ConnectionSecurityView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("This removes the connection from this device only. It does not revoke this device on your Mac. To remove Mac-side access, open Agentbot → Settings → Phone and remove it there.")
        }
    }
    ...
    private var troubleshootingText: Text {
        ...
        case .connecting:
            return Text("Agentbot is trying the saved connection automatically.")
