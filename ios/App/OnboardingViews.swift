                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 8) {
                        Text("Connect when you're ready")
                            .font(.title2.bold())
                        Text("Pair this device with Agentbot to see your chats and respond to your bots.")
                            .foregroundStyle(.secondary)
                            .multilineTextAlignment(.center)
                            .fixedSize(horizontal: false, vertical: true)
                    }

                    Text("On your computer, open Agentbot → Settings → Phone.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
            ...
            VStack(spacing: 10) {
                ...
                VStack(spacing: 10) {
                    Text("Stay in the loop")
                        .font(.largeTitle.bold())
                    Text("Get alerts while Agentbot is open or was recently in the background. Alerts stop after iOS fully suspends or closes the app.")
                        .font(.title3)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                        .fixedSize(horizontal: false, vertical: true)
