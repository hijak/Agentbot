...
private let log = Logger(subsystem: "com.agentbot.companion", category: "stream")
...
final class Session: ObservableObject {
    ...
    private func restore() {
        ...
        registry = AgentbotSharedConnectionStore.loadRegistry()
        connections = registry.connections
    ...
    private func commitPairing(_ stored: Connection, token: String, winner: CompanionEndpoint? = nil) throws {
        ...
        CompanionPairingCommitSequence.persist {
            ...
            AgentbotSharedConnectionStore.saveRegistry(updatedRegistry)
        }
    ...
    /// `GET /.well-known/agentbot/environment` on a server about to be
    ...
    private static func confirmServer(at connection: Connection) async throws {
        ...
        do {
            ...
            throw APIError.transport(
                "\(connection.displayAddress) isn't an Agentbot server. Check the address and try again."
            )
        }
    }
    ...
    private func persistRegistry() {
        AgentbotSharedConnectionStore.saveRegistry(registry)
    }
        ...
        do {
            ...
            if attachments.contains(where: { $0.kind == .image }) {
                ...
                do {
                    ...
                    actionError = "Update Agentbot on this computer before sending images."
                    return false
                }
    ...
    nonisolated private static func materializePreview(
        ...
        let root = manager.temporaryDirectory
            .appendingPathComponent("AgentbotFilePreviews", isDirectory: true)
