...
enum AgentbotSharedConfiguration {
    static let appGroupIdentifier = "group.com.agentbot.shared"
    static let legacyAppBundleIdentifier = "com.agentbot.app"
    static let keychainAccessGroupInfoKey = "AgentbotKeychainAccessGroup"
