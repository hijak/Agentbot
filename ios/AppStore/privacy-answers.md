...
- Privacy policy URL:
  `https://github.com/milind-soni/Agentbot/blob/main/docs/ios-privacy.md`
...
companion computer, and local Wi-Fi and Tailscale pairing require no Agentbot
...
**Send**. They are written to that computer's local Agentbot attachments
