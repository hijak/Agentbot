...
AgentbotMobile is a companion for the Agentbot desktop application. The
...
1. Install and start Agentbot on a Mac, Windows, or Linux computer.
...
6. In Safari, Notes, Photos, or Files, open the system Share sheet and choose
   **Agentbot**. The extension shows the paired computer and asks for a bot
...
specific computer and receives no universal Agentbot account credential.
The reviewer may use any email inbox they control. This optional path uses an
Agentbot-managed Cloudflare Tunnel and does not require Tailscale.
