...
/// Pairing with a server directly (`agentbot serve`, the Docker stack):
...
final class ServerPairingTests: XCTestCase {
    ...
    func testTheServersLinkBecomesAHostedInviteWithTheNormalizedCode() throws {
        let invite = try XCTUnwrap(PairingInvite.parse(XCTUnwrap(URL(string: "https://c-7f3a9c.agentbot.com/pair#code=abcd-efgh-jklm"))))
        XCTAssertEqual(invite.credential, "ABCDEFGHJKLM")
        XCTAssertEqual(invite.connection.activeEndpoint?.kind, .hosted)
        XCTAssertEqual(invite.connection.activeEndpoint?.url, "https://c-7f3a9c.agentbot.com")
        XCTAssertEqual(invite.connection.host, "c-7f3a9c.agentbot.com")
    ...
    func testOnlyAWellFormedServerLinkIsAccepted() throws {
        ...
        XCTAssertNotNil(PairingInvite.parse(try XCTUnwrap(URL(string: "agentbot://pair?address=192.168.1.9:8810&code=123456"))))
    }
    ...
    func testPairingPostsTheCodeWithoutACookieAndKeepsTheBearer() async throws {
        ...
        let connection = try XCTUnwrap(Connection.parse("https://c-7f3a9c.agentbot.com"))
        ...
        XCTAssertEqual(request.url?.absoluteString, "https://c-7f3a9c.agentbot.com/api/auth/pair")
    ...
    func testTheDescriptorIsReadableWithoutASession() async throws {
        ...
        XCTAssertEqual(ServerRequestStub.captured().first?.url?.path, "/.well-known/agentbot/environment")
    }
    ...
    func testOnlyAnAdminScopedServerSessionMayAdminister() throws {
        ...
        var chatOnly = try XCTUnwrap(Connection.parse("https://c-7f3a9c.agentbot.com"))
        ...
        let earlier = Data(#"{"id":"s1","name":"cab mini","host":"c-7f3a9c.agentbot.com","port":443,"serverEnvironmentId":"env_7f3a9c"}"#.utf8)
    ...
    func testAServerConnectionsStreamCarriesTheBearerAndResumesFromTheCursor() async throws {
        ...
        var connection = try XCTUnwrap(Connection.parse("https://c-7f3a9c.agentbot.com"))
        ...
        XCTAssertEqual(components.host, "c-7f3a9c.agentbot.com")
