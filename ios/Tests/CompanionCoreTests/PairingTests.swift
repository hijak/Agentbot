...
final class PairingTests: XCTestCase {
    ...
    func testRejectsAServiceThatDoesNotIdentifyAsAgentbot() async throws {
    ...
    private static let health = Data(#"{"app":"agentbot","pid":42,"static":true}"#.utf8)
