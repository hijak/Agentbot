> ⚠️ **No affiliation with any cryptocurrency.** Agentbot has no token. Any coin using the Agentbot, Maus, or SupaMaus name is not created, endorsed, or affiliated with this project or its maintainer. I have received no tokens, payment, or allocation from anyone, and I will not be endorsing any token.
...
[![Release](https://img.shields.io/github/v/release/milind-soni/Agentbot?label=release&color=1084fe&cacheSeconds=300)](https://github.com/milind-soni/Agentbot/releases/latest)
![PRs](https://img.shields.io/badge/PRs-welcome-38d591)

<br>

<a href="https://github.com/milind-soni/Agentbot/releases/latest/download/Agentbot.dmg">
  <img src="https://img.shields.io/github/v/release/milind-soni/Agentbot?style=for-the-badge&label=%E2%AC%87%EF%B8%8F%20%20Download%20for%20Mac%20%28Apple%20silicon%29&labelColor=070707&color=1084fe&cacheSeconds=300" alt="Download the latest Agentbot for Mac with Apple silicon (.dmg)" height="40">
</a>
&nbsp;
<a href="https://github.com/milind-soni/Agentbot/releases/latest/download/Agentbot-intel.dmg">
  <img src="https://img.shields.io/github/v/release/milind-soni/Agentbot?style=for-the-badge&label=%E2%AC%87%EF%B8%8F%20%20Download%20for%20Mac%20%28Intel%29&labelColor=070707&color=2a9d8f&cacheSeconds=300" alt="Download the latest Agentbot for Intel Macs (.dmg)" height="40">
</a>
&nbsp;
<a href="https://github.com/milind-soni/Agentbot/releases/latest/download/Agentbot-setup.exe">
  <img src="https://img.shields.io/github/v/release/milind-soni/Agentbot?style=for-the-badge&label=%E2%AC%87%EF%B8%8F%20%20Download%20for%20Windows&labelColor=070707&color=4cc2ff&cacheSeconds=300" alt="Download the latest Agentbot for Windows (.exe)" height="40">
</a>
&nbsp;
<a href="https://github.com/milind-soni/Agentbot/releases/latest/download/Agentbot-amd64.deb">
  <img src="https://img.shields.io/github/v/release/milind-soni/Agentbot?style=for-the-badge&label=%E2%AC%87%EF%B8%8F%20%20Download%20for%20Ubuntu&labelColor=070707&color=e95420&cacheSeconds=300" alt="Download the latest Agentbot for Ubuntu (.deb)" height="40">
</a>

<sub>[latest release](https://github.com/milind-soni/Agentbot/releases/latest) &nbsp;·&nbsp; macOS: Apple silicon & Intel · signed & notarized .dmg &nbsp;·&nbsp; Windows: x64 installer &nbsp;·&nbsp; Ubuntu 24.04 x64: .deb or AppImage beta &nbsp;·&nbsp; [all releases](https://github.com/milind-soni/Agentbot/releases)</sub>

<br>

<a href="https://buy.polar.sh/polar_cl_bbnfWFUrWONIF4HnUpZf1p0if0eUYg3HeXct73b48Yg">
  <img src="https://img.shields.io/badge/%E2%9D%A4%EF%B8%8F%20%20Support%20Agentbot-any%20amount%20%C2%B7%20or%20monthly-38d591?style=for-the-badge&labelColor=070707" alt="Support Agentbot — one-time any amount or monthly, via Polar" height="40">
</a>

<br>
<br>

<img src="docs/screenshots/hero.png" alt="Agentbot — a Telegram-style chat app where every chat is a real AI agent" width="900">
...
One assistant in one box is the wrong shape for agents. Agentbot is an independent, open-source project inspired by **Grok Bot** —
...
- **Local first.** One small harness server on `127.0.0.1` owns every agent process. Transcripts, keys, and
  events live in `~/.agentbot`, not a cloud.
...
Browse outcome-driven teams on [BotMRR](https://botmrr.io), then choose **Add to Agentbot**. The app
...
The format stays portable: Agentbot reads the structured YAML frontmatter for a reliable one-click
...
[open-source playbook repository](https://github.com/milind-soni/agentbot-teams) or read its
[portable format](https://github.com/milind-soni/agentbot-teams/blob/main/FORMAT.md).
...
### Orchestrate Agentbot over MCP

Agentbot ships a stdio MCP server for external clients such as Claude Desktop and Cursor. It exposes a
...
**Released builds ([latest release](https://github.com/milind-soni/Agentbot/releases/latest)):** the harness server is embedded, so no separate server setup is required.

| | Download | Install |
|---|---|---|
| **macOS** (Apple silicon) | [Agentbot.dmg](https://github.com/milind-soni/Agentbot/releases/latest/download/Agentbot.dmg) | Drag it to Applications, open it. Signed & notarized. |
| **macOS** (Intel) | [Agentbot-intel.dmg](https://github.com/milind-soni/Agentbot/releases/latest/download/Agentbot-intel.dmg) | Same app, built for Intel Macs. Signed & notarized. |
| **Windows** (x64) | [Agentbot-setup.exe](https://github.com/milind-soni/Agentbot/releases/latest/download/Agentbot-setup.exe) | Run it — one-click, per-user, no admin rights. The installer isn't code-signed yet, so SmartScreen shows "unknown publisher": **More info → Run anyway**. |
| **Ubuntu 24.04** (x64) | [Agentbot-amd64.deb](https://github.com/milind-soni/Agentbot/releases/latest/download/Agentbot-amd64.deb) · [Agentbot.AppImage](https://github.com/milind-soni/Agentbot/releases/latest/download/Agentbot.AppImage) | Install the `.deb` with APT (recommended), or make the AppImage executable and run it. Beta; GNOME is the supported desktop. |
...
```sh
git clone https://github.com/milind-soni/Agentbot && cd Agentbot
pnpm install
...
issues [#29](https://github.com/milind-soni/Agentbot/issues/29),
[#345](https://github.com/milind-soni/Agentbot/issues/345), and
[#113](https://github.com/milind-soni/Agentbot/issues/113).
...
|---|---|---|
| Composio project key (`ak_…`) | Connect Gmail, GitHub, Slack, Notion, and other apps to your bots | [Agentbot Composio setup](docs/composio.md) |
...
Agentbot starts a webhook-only receiver on `127.0.0.1:8800` by default (or one port above `AGENTBOT_PORT`).
Set `AGENTBOT_WEBHOOK_PORT` to choose another port. A webhook secret is shown once when the trigger is created
...
Agentbot must remain running to accept a delivery. For public internet delivery, proxy only this
...
Agentbot is free and open source. If it does real work for you, you can
...
```sh
npm install -g agentbot
agentbot
```

Or use `npx agentbot` without a global install. First launch guides you with
...
Run `agentbot setup` to reconfigure without resetting bots or conversations;
...
`npx agentbot serve` with explicit remote options: `--tailscale` for your
tailnet, `--domain` for your own domain with automatic HTTPS, or the Docker
stack. These are separate from
...
[Apache License 2.0](LICENSE) © 2026 Milind Soni and Agentbot contributors,
...
Agentbot is an independent, open-source project inspired by Grok Bot. It is
